...
listePartie.push(new Partie('0', new Joueur('Albert', 'Ramos', 28, 56, 'Espagne'), new Joueur('Milos', 'Raonic', 28, 16, 'Canada'), '1', 'Hale', '12h30', 70));
listePartie.push(new Partie('1', new Joueur('Andy', 'Murray', 28, 132, 'Angleterre'), new Joueur('Andy', 'Roddick', 36, 1000, 'États-Unis'), '2', 'Hale', '13h00', 150));
listePartie.push(new Partie('2', new Joueur('Novak', 'Djokovic', 31, 3, 'Serbie'), new Joueur('Jo-Wilfried', 'Tsonga', 33, 30, 'France'), '4', 'Hale', '14h15', 300));
listePartie.push(new Partie('3', new Joueur('Roger', 'Federer', 37, 2, 'Suisse'), new Joueur('Rafael', 'Nadal', 32, 1, 'Espagne'), '3', 'Hale', '18h00', 700));
